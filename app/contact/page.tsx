                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <div className="">
                        ...
                        <p className="text-gray-700 py-5">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas, eaque.</p>
                        <ul className="list-item space-y-6 pt-8" >
                            <li className="flex gap-5">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="">assethimsi@gmail.com</p>
                                </div>
                            </li>
                            <li className="flex gap-5">
                                <div className="flex-none bg-gray-300 p-3 shadow-sm rounded-sm">
                            ...
                            <li className="flex gap-5">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="">Jl. Bali, Kota Bengkulu 38119, Kelurahan Bajak, Kecamatan Teluk Segara</p>
                                </div>
                            </li>
                        </ul>
                    </div>
