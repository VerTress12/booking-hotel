                    ...
                    <li className='py-2'>
                        <div className="flex items-center">
                            ...
                            <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                {formatDate(reservation.createdAt.toString())}</div>
                        </div>
                    </li>
                    <li className='py-2'>
                        <div className="flex items-center">
                ...
                <ul>
                    ...
                    <li className='py-2'>
                        <div className="flex items-center">
                            ...
                            <div className="inline-flex items-center text-base font-semibold text-gray-900">
                                {reservation.Payment?.status}</div>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <table className='w-full text-sm text-left text-gray-500'>
                    ...
                    <tbody>
                        <tr className='bg-white border-b'>
                            ...
                            <td className='px-6 py-3'>{formatDate(reservation.startDate.toString())}</td>
                            <td className='px-6 py-3'>{formatDate(reservation.endDate.toString())}</td>
                            <td className='px-6 py-3'>
