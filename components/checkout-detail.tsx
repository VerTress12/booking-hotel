...
const CheckoutDetail = async ({ reservationId }: { reservationId: string }) => {
  ...
  if (!reservation) return <h1>No Reservation Found</h1>
            ...
            <div className="border border-gray-200 px-3 py-5 bg-white rounded-sm">
                <table className="w-full">
                    <tbody>
                        ...
                        <tr>
                            <td className="py-2">Phone <Number></Number></td>
                            <td className="py-2 text-right truncate">{reservation.User.phone}</td>
                        </tr>
                        <tr>
                            <td className="py-2">Arrival</td>
                            <td className="py-2 text-right truncate">{formatDate(reservation.startDate.toDateString())}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td className="py-2 text-right truncate">
                                <span>
                                  {reservation.Payment?.amount ? formatCurrency(reservation.Payment.amount) : "Belum dibayar"}
                                </span>
                            </td>
                        </tr>
                         <tr>
