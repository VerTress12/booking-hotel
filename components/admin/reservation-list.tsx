    ...
    return (
        <div className='bg-white p-4 mt-5 shadow-sm'>
            <table className='w-full divide-y divide-gray-200'>
                <thead>
                    <tr>
                        <th className='px-6 py-3 w-32 text-sm font-bold text-gray-700 
                    uppercase text-left'>Image</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase text-left'>Customer Name</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase text-left'>Arrival</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase text-left'>Departure</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase text-left'>Room Name</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase text-left'>Price</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase text-left'>Created At</th>
                        <th className='px-6 py-3  text-sm font-bold text-gray-700 
                    uppercase'>Status</th>
                    </tr>
                </thead>
